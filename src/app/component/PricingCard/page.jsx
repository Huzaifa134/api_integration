...
const PricingCard = () => {
  return (
    <div className="flex justify-center flex-wrap items-center gap-5 mt-10 mb-10">
      {/*card1*/}
      <div className="bg-[#161618] w-96 p-8 rounded-3xl">
      ...
      {/*card2*/}
      <div
        className="bg-[#161618] w-96 pl-8 pr-8 pb-8 pt-4 rounded-3xl"
        style={{
      ...
      >
        <div
          ...
          style={{ background: "linear-gradient(to right, #DF9913, #6B0485)" }}
        >
